...
import edu.xmu.software.truckrent.util.overlayutil.MassTransitRouteOverlay;
import edu.xmu.software.truckrent.util.overlayutil.OverlayManager;
import edu.xmu.software.truckrent.util.overlayutil.PoiOverlay;
import edu.xmu.software.truckrent.util.overlayutil.TransitRouteOverlay;
import edu.xmu.software.truckrent.util.overlayutil.WalkingRouteOverlay;

public class MapActivity extends Activity implements OnGetPoiSearchResultListener,OnGetSuggestionResultListener, BaiduMap.OnMapClickListener,OnGetRoutePlanResultListener {
    ...
    String startCity="北京",endCity="天安门";
    String startPlace="上海",endPlace="东方明珠";
    String startNodeStr = "西二旗";
    String endNodeStr = "龙泽";

    EditText etEndCity,etEndPlace;//路径规划终点城市和地方
...
//                .findFragmentById(R.id.map))).getBaiduMap();
        ...
        etEndCity= (EditText) findViewById(R.id.endCity);
        etEndPlace= (EditText) findViewById(R.id.endPlace);
        // 地图点击事件处理
...
//        startPlace="西二旗";
        ...
        endCity=etEndCity.getText().toString();
    ...
    public void findFood(View v){
        PoiNearbySearchOption nearbySearchOption = new PoiNearbySearchOption().keyword("饭店").sortType(PoiSortType.distance_from_near_to_far).location(center)
                .radius(radius).pageNum(loadIndex);
        mPoiSearch.searchNearby(nearbySearchOption);
    }
    /**
    ...
    public void findHouse(View v){
        PoiNearbySearchOption nearbySearchOption = new PoiNearbySearchOption().keyword("住宿").sortType(PoiSortType.distance_from_near_to_far).location(center)
                .radius(radius).pageNum(loadIndex);
        mPoiSearch.searchNearby(nearbySearchOption);
    }
    /**
     ...
     * @param v
     */
    public void findGasStation(View v){
        PoiNearbySearchOption nearbySearchOption = new PoiNearbySearchOption().keyword("加油站").sortType(PoiSortType.distance_from_near_to_far).location(center)
                .radius(radius).pageNum(loadIndex);
        mPoiSearch.searchNearby(nearbySearchOption);
    }
    /**
     ...
     * @param v
     */
    public void findServeStation(View v){
        PoiNearbySearchOption nearbySearchOption = new PoiNearbySearchOption().keyword("维修站").sortType(PoiSortType.distance_from_near_to_far).location(center)
                .radius(radius).pageNum(loadIndex);
        mPoiSearch.searchNearby(nearbySearchOption);
    }
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            startPlace=location.getDistrict();
